...
{{--    <link rel="manifest" href="/manifest.json">--}}
    ...
    <style>
        ...
        @media print
        {
            ...
            .kt-portlet__head , .kt-portlet__head  *
            {
                display: none !important;
            }
            .fullPage-print
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed no-print">
    <div class="kt-header-mobile__logo">
        <a href="{{route(auth()->guard('admin')->check() ? 'driver.admin.home' : 'driver.panel.dashboard')}}">
            @if($settingInfo['logo'])
...
<div class="kt-grid kt-grid--hor kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper fullPage-print" id="kt_wrapper">
...
-->
                <div class="kt-header-menu-wrapper no-print" id="kt_header_menu_wrapper">
                    ...
                    <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                        <div class="kt-header__topbar-user kt-hidden-desktop" style="padding: 15px;">
                            ...
                            <a href="{{ auth()->guard('admin')->check() ? route('driver.admin.logout') : route('driver.panel.logout')  }}" class="btn btn-icon btn-outline-danger btn-sm kt-pull-right"><i class="fa fa-sign-out-alt"></i></a>
                        </div>
...
{{--                                                </span>--}}
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
                                ...
                                <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true">
                                            <a href="{{ route('driver.admin.orders.search' , ['received']) }}" class="kt-menu__link ">
                                                <span class="kt-menu__link-icon">
                                                    <i class="fa fa-dolly"></i>
                                                </span>
                                                <span class="kt-menu__link-text">Received Orders</span>
                                            </a>
                                        </li>
                                        <li class="kt-menu__item " aria-haspopup="true">
                            ...
                            @else
                                ...
                                <li class="kt-menu__item" aria-haspopup="true">
                                    <a href="{{route('driver.panel.orders.history')}}" class="kt-menu__link">
                                        <i class="fa fa-handshake"></i>
            ...
            <!-- begin:: Footer -->
            <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop  no-print" id="kt_footer" >
...
<!-- begin::Scrolltop -->
<div id="kt_scrolltop" class="kt-scrolltop  no-print">
...
<script>
    ...
    $( window ).on( "load", function() {
        $(".changeorderstatus").click(function () {
            ...
            $.ajax({
                type: "GET",
                url: '{{ route( auth()->guard('admin')->check() ? 'driver.admin.orders.status' : 'driver.panel.orders.status' ) }}',
                ...
                success: function (msg) {
                    ...
                    if (msg.status == 200) {
                        $("#OrderStatusMsg" + id).addClass('alert-solid-success');
                        //notification start
                        ...
                        $("#OrderStatusMsg" + id).addClass('alert-solid-danger');
                        //notification start
                        var notify = $.notify({message: msg.message});
                        notify.update('type', 'danger');
                        //notification end
                    }
                    $("#OrderStatusMsg" + id).show();
                },
                error: function (msg) {
                    //notification start
...
{{--            navigator.serviceWorker.register('{{ route('driver.panel.serviceWorker') }}?v=3').then(registration => {--}}

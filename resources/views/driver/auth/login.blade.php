					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								...
								<img  style="max-width:200px;" alt="{{__('adminMessage.websiteName')}}" src="{!! url('uploads/logo/'.$settingDetailsMenu['logo']) !!}" />
                                @endif
							    </a>
							</div>
   @php
   ...
   @endphp 
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign in to Admin Panel of Drivers</h3>
								</div>
   
								<form class="kt-form"  name="AdmloginForm" id="AdmloginForm" method="POST" action='{{ route("driver.admin.login") }}'>

...
@section('breadcrumb' )
    ...
    <li class="breadcrumb-item active">{{ __('webMessage.searchResults')  }}</li>
@endsection
                            ...
                            <div class="product_header">
                                <div class="product_header_left">
                                    <div class="custom_select">
                                        <select name="search_sort_by" id="search_sort_by"  class="form-control form-control-sm">
                                ...
                                <div class="product_header_right">
                                    ...
                                    <div class="custom_select">
                                        <select  class="form-control form-control-sm" name="search_per_page" id="search_per_page">

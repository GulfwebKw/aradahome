...
@section('title' , __('webMessage.offers')  )
@section('breadcrumb' )
    <li class="breadcrumb-item"><a href="{{url(app()->getLocale().'/')}}">{{__('webMessage.home')}}</a></li>
    <li class="breadcrumb-item active">{{__('webMessage.offers')}}</li>
@endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="product_header">
                                <div class="product_header_left">
                                    <div class="custom_select">
                                        <select name="offer_sort_by" id="offer_sort_by" mykey="offer" class="form-control form-control-sm">
                                ...
                                <div class="product_header_right">
                                    ...
                                    <div class="custom_select">
                                        <select  class="form-control form-control-sm" name="offer_per_page" id="offer_per_page" mykey="offer" >
                    ...
                    @if (!empty($offerProductLists) && count($offerProductLists) > 0)
                        <div class="row shop_container grid">
                            @php $tagsDetails=''; @endphp
                            @foreach ($offerProductLists as $productList)
                        ...
                        <div class="row">
                            <div class="col-12 mt-2 mt-md-4">
                                <div class="pagination pagination_style1 justify-content-center">
                                    {!! $offerProductLists->appends($_GET)->links() !!}
                                </div>
                            </div>
                        </div>
                    @else

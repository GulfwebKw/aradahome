...
@endphp
@section('title' , $sectionDetails['title_'.$strLang]  )
...
@section('breadcrumb' )
    ...
    <li class="breadcrumb-item active">{{ $sectionDetails['title_'.$strLang]  }}</li>
@endsection
                            ...
                            <div class="product_header">
                                <div class="product_header_left">
                                    <div class="custom_select">
                                        <select name="product_sort_by" id="product_sort_by" mykey="sec"  class="form-control form-control-sm">
                                ...
                                <div class="product_header_right">
                                    ...
                                    <div class="custom_select">
                                        <select  class="form-control form-control-sm" name="product_per_page" id="product_per_page" mykey="sec">

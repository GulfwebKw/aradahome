...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.createcolor')}}</title>
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.createcolor')}}</a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">{{__('adminMessage.createcolor')}}</h3>
									</div>
									
								</div>				
										<!--begin::Form-->
					@if(auth()->guard('admin')->user()->can('color-create'))
                    
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('color.store')}}">
											...
											<div class="form-group row">
													<div class="col-lg-6">
														...
														<input type="text" class="form-control @if($errors->has('details_en')) is-invalid @endif" name="details_en"
															   value="{{old('details_en')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_details_en')}}" />
													...
													<div class="col-lg-6">
														...
														<input dir="rtl" type="text" class="form-control @if($errors->has('details_ar')) is-invalid @endif" name="details_ar"
															   value="{{old('details_ar')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_details_ar')}}" />
                                         ...
                                         <div class="form-group row">
                                               <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('color_code')) is-invalid @endif demo"  data-control="hue"  id="hue-demo" name="color_code"
                                                               value="{{old('color_code')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_color_code')}}" />

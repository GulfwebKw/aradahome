<div class="kt-list-timeline__items">
    ...
    @foreach($childs as $child)
         ...
         <span class="kt-switch"><label><input value="{{$child->id}}" {{!empty($child->is_highlighted)?'checked':''}} type="checkbox"  id="highlighted" class="change_status"><span></span></label></span>
         </span>
         <span class="kt-list-timeline__time">
         @if($child->image)

...
<head>
    <meta charset="utf-8"/>
    <title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.quickedit')}}</title>
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:;"
                                   class="kt-subheader__breadcrumbs-link">{{__('adminMessage.quickedit')}}</a>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                            ...
                            <form name="tFrm" id="form_validation" method="post"
                                  ...
                                  action="{{route('product.quickEdit',$product->id)}}">
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="sku_no"
                                                   value="{{old('sku_no')?:$product->sku_no}}" autocomplete="off"
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text"
                                                   ...
                                                   autocomplete="off"
                                                   placeholder="{{__('adminMessage.enter_weight')}}"/>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text"
                                                   ...
                                                   autocomplete="off"
                                                   placeholder="{{__('adminMessage.enter_height')}}"/>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text"
                                                   ...
                                                   autocomplete="off" placeholder="{{__('adminMessage.enter_width')}}"/>
                                            @if($errors->has('width'))
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="depth" value="{{old('depth')?:$product->depth}}"
                                                   autocomplete="off" placeholder="{{__('adminMessage.enter_depth')}}"/>
                                            @if($errors->has('depth'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="old_price"
                                                   value="{{old('old_price')?:$product->old_price}}" autocomplete="off"
                                        ...
                                        <div class="col-lg-3">
                                            <label>{{__('adminMessage.cost_price')}}<span
                                                        id="profitprice"></span></label>
                                            <input type="text"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input required type="text"
                                                   ...
                                                   name="title_en"
                                                   value="{{old('title_en')?:$product->title_en}}" autocomplete="off"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input required type="text"
                                                   ...
                                                   name="title_ar"
                                                   value="{{old('title_ar')?:$product->title_ar}}" autocomplete="off"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="extra_title_en"
                                                   value="{{old('extra_title_en')?:$product->extra_title_en}}"
                                                   autocomplete="off"
                                                   placeholder="{{__('adminMessage.enter_title_en')}}"/>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="extra_title_ar"
                                                   value="{{old('extra_title_ar')?:$product->extra_title_ar}}"
                                                   autocomplete="off"
                                                   placeholder="{{__('adminMessage.enter_title_ar')}}"/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <textarea rows="3" id="sdetails_en" name="sdetails_en"
                                                      ...
                                                      autocomplete="off"
                                                      placeholder="{{__('adminMessage.enter_sdetails_en')}}">{{old('sdetails_en')?:$product->sdetails_en}}</textarea>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea rows="3" id="sdetails_ar" name="sdetails_ar"
                                                      ...
                                                      autocomplete="off"
                                                      placeholder="{{__('adminMessage.enter_sdetails_ar')}}">{{old('sdetails_ar')?:$product->sdetails_ar}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <textarea rows="3" id="details_en" name="details_en"
                                                      ...
                                                      autocomplete="off"
                                                      placeholder="{{__('adminMessage.enter_details_en')}}">{{old('details_en')?:$product->details_en}}</textarea>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea rows="3" id="details_ar" name="details_ar"
                                                      ...
                                                      autocomplete="off"
                                                      placeholder="{{__('adminMessage.enter_details_ar')}}">{{old('details_ar')?:$product->details_ar}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                            ...
                                            <select class="form-control @if($errors->has('is_attribute')) is-invalid @endif"
                                                ...
                                                @php
                                                    $is_attribute = old('is_attribute') ?: $product->is_attribute;
                                                @endphp
                                                <option value="1"
                                                        @if($is_attribute==1) selected @endif >{{__('adminMessage.yes')}}</option>
                                                <option value="0"
                                                        @if($is_attribute==0) selected @endif >{{__('adminMessage.no')}}</option>
                                            </select>
                                        ...
                                        <div class="col-lg-2" id="box-quantity"
                                             @if(!empty($is_attribute)) style="display:none;"
                                            ...
                                            <input type="number"
                                                   ...
                                                   name="quantity"
                                                   value="{{old('quantity')?:$product->quantity}}" autocomplete="off"
                                            ...
                                            <select class="form-control @if($errors->has('warranty')) is-invalid @endif"
                                                ...
                                                @if(!empty($warrantyLists) && count($warrantyLists)>0)
                                                    @foreach($warrantyLists as $warrantyList)
                                                        <option value="{{$warrantyList->id}}" @if($product->warranty == $warrantyList->id) selected @endif>
                                                            {{$warrantyList->title_en}}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="form-control" name="homesection">
                                                @php
                                                    $homesection = old('homesection') ?: $product->homesection;
                                                @endphp
                                                <option value="0"
                                                        @if($homesection==0) selected @endif>{{__('adminMessage.none')}}</option>
                                                @if(!empty($sections))
                                                    @foreach($sections as $section)
                                                        <option value="{{$section->id}}"
                                                                @if($homesection==$section->id) selected @endif>
                                                            {{$section->title_en}}
                                                        </option>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="form-control" name="prodstatus">
                                                @php
                                                    $is_active = old('is_active') ?: $product->is_active;
                                                @endphp
                                                <option value="0"
                                                        @if($is_active==0) selected @endif>{{__('adminMessage.notpublished')}}</option>
                                                <option value="1"
                                                        @if($is_active==1) selected @endif>{{__('adminMessage.published')}}</option>
                                                <option value="2"
                                                        @if($is_active==2) selected @endif>{{__('adminMessage.publishedpreorder')}}</option>
                                            </select>
                                        </div>
                                        @php
                                            $manufacturer_id = old('manufacturer') ?: $product->manufacturer_id;
                                        @endphp
                                                ...
                                                <select class="form-control" name="manufacturer">
                                                    ...
                                                    @foreach($manufacturers as $manufacturer)
                                                        <option value="{{$manufacturer->id}}"
                                                                @if($manufacturer_id==$manufacturer->id) selected @endif>{{$manufacturer->title_en}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        @endif
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2">
                                            @if($product->image)
                                                <img class=""
                                                     src="{!! url('uploads/product/thumb/'.$product->image) !!}"
                                                     width="35" height="35">
                                                &nbsp;
                                                <a href="{{url('vendor/product/deleteImage/'.$product->id)}}"
                                        ...
                                        <div class="col-lg-2">
                                            @if($product->rollover_image)
                                                <img class=""
                                                     src="{!! url('uploads/product/thumb/'.$product->rollover_image) !!}"
                                                     width="35" height="35">
                                                &nbsp;
                                                <a href="{{url('vendor/product/deleteRolloverImage/'.$product->id)}}"
                                                   class="btn btn-brand btn-danger btn-icon-sm btn-sm "><i
                                                            class="la la-trash"></i>{{__('adminMessage.delete')}}
                                                </a>
                                            @endif
                                        ...
                                        <div class="col-lg-10">
                                            <label>{{trans('theme')['theme'.$theme]['attachfile']}}
                                            </label>
                                        ...
                                        <div class="col-lg-2">
                                            @if(!empty($product->attachfile))
                                                (<a href="{{url('uploads/product/'.$product->attachfile)}}"
                                                    target="_blank">View</a>)
                                            @endif
                                            &nbsp;
                                            @if(!empty($product->attachfile))
                                                <a href="{{url('vendor/product/deletePdf/'.$product->id)}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach($productCats as $productCat)
                                            <div class="row">
                                                    ...
                                                    <div class="kt-form__group--inline">
                                                        <div class="kt-form__control">
                                                            <select name="categories[]" class="form-control">
                                                                <option value="0">{{__('adminMessage.chooseCategory')}}</option>
                                                                @foreach($categories as $category)
                                                                    <option style="font-size:20px;" value="{{$category->id}}"
                                                                            @if($productCat->category_id == $category->id) selected @endif >
                                                                             {{$category->name_en}}
                                                                    </option>
                                                                    @if(count($category->childs))
                                                                       
                                                                        @include('gwc.product.dropdown_childs',['productCatId'=>$productCat->category_id,'ParentName'=>$category->name_en,'childs' => $category->childs,'level'=>0])
                                                                    @endif
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col-md-1">
                                                    <a href="{{url('vendor/product/'.$product->id.'/deleteprodcategory/'.$productCat->id)}}"
                                                                ...
                                                                <div class="kt-form__control">
                                                                    <select name="category" class="form-control">
                                                                        ...
                                                                        @foreach($categories as $category)
                                                                            ...
                                                                            @if(count($category->childs))
                                                                                @include('gwc.product.dropdown_childs',['productCatId'=>0,'ParentName'=>$category->name_en,'childs' => $category->childs,'level'=>0])
                                                                            @endif
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea name="tags_ar" id="tags_ar"
                                                      ...
                                                      autocomplete="off">{{old('tags_ar')?:$product->tags_ar}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <textarea name="seokeywords_en"
                                                      ...
                                                      autocomplete="off">{{old('seokeywords_en')?:$product->seokeywords_en}}</textarea>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea name="seokeywords_ar"
                                                      ...
                                                      autocomplete="off">{{old('seokeywords_ar')?:$product->seokeywords_ar}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <textarea name="seodescription_en"
                                                      ...
                                                      autocomplete="off">{{old('seodescription_en')?:$product->seodescription_en}}</textarea>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea name="seodescription_ar"
                                                      ...
                                                      autocomplete="off">{{old('seodescription_ar')?:$product->seodescription_ar}}</textarea>
...
<script src="{{url('admin_assets/assets/js/pages/crud/forms/widgets/bootstrap-datepicker.js')}}"

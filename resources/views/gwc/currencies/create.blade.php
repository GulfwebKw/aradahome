...
<head>
    <meta charset="utf-8" />
    <title>{{ __('adminMessage.websiteName') }}|{{ __('adminMessage.createcurrency') }}</title>
                        ...
                        <div class="kt-container  kt-container--fluid ">
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__breadcrumbs">
                                    ...
                                    <a href="javascript:;"
                                        class="kt-subheader__breadcrumbs-link">{{ __('adminMessage.createcurrency') }}</a>
                                </div>
                            </div>
                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head kt-portlet__head--lg">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <h3 class="kt-portlet__head-title">{{ __('adminMessage.createcurrency') }}</h3>
                                </div>
                                    ...
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="symbol" value="{{ old('symbol') }}" autocomplete="off"
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="rate" value="{{ old('rate') }}" autocomplete="off"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text"
                                                    class="form-control @if ($errors->has('title_ar')) is-invalid @endif"
                                                    name="title_ar" value="{{ old('title_ar') }}" autocomplete="off"

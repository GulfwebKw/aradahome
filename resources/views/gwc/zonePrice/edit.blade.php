...
<head>
    <meta charset="utf-8" />
    <title>{{ __('adminMessage.websiteName') }}|{{ __('adminMessage.edit') }}</title>
                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head kt-portlet__head--lg">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <h3 class="kt-portlet__head-title">{{ __('adminMessage.edit') }}</h3>
                                </div>
                            ...
                            @if (auth()->guard('admin')->user()->can('currency-edit'))
                                <form name="tFrm" id="form_validation" method="post" class="kt-form"
                                    action="{{ url('gwc/zones/'.$zone->id.'/price/' . $price->id) }}">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="number" required step="0.5"
                                                       ...
                                                       name="from" value="{{ old('from' , $price->from ) }}" autocomplete="off"
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="number" required step="0.5"
                                                       ...
                                                       name="to" value="{{ old('to' , $price->to ) }}" autocomplete="off"
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="number" required step="0.01"
                                                       ...
                                                       name="price" value="{{ old('price' , $price->price) }}" autocomplete="off"

                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2">
                                            @if($product->image)
                                                <img class=""
                                                     ...
                                                     width="35" height="35">
                                                &nbsp;
                                                <a href="{{url('gwc/product/deleteImage/'.$product->id)}}"
                                        ...
                                        <div class="col-lg-2">
                                            @if($product->rollover_image)
                                                <img class=""
                                                     ...
                                                     width="35" height="35">
                                                &nbsp;
                                                <a href="{{url('gwc/product/deleteRolloverImage/'.$product->id)}}"
                                                   class="btn btn-brand btn-danger btn-icon-sm btn-sm "><i
                                                            class="la la-trash"></i>{{__('adminMessage.delete')}}
                                                </a>
                                            @endif
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            &nbsp;
                                            @if(!empty($product->attachfile))
                                                <a href="{{url('gwc/product/deletePdf/'.$product->id)}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach($productCats as $productCat)
                                            <div class="row">
                                                ...
                                                <div class="col-md-1">
                                                    <a href="{{url('gwc/product/'.$product->id.'/deleteprodcategory/'.$productCat->id)}}"

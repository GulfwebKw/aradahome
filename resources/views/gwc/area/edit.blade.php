...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.editarea')}}</title>
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
                                        ...
                                        @endif
										<span class="kt-subheader__breadcrumbs-separator"></span>
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.editarea')}}</a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">{{__('adminMessage.editarea')}}</h3>
									</div>
                    ...
                    <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('area.update',[$editarea->id,$editarea->parent_id])}}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                       ...
                                       <!--categories name -->         
                                                ...
                                                <input type="text" class="form-control @if($errors->has('name_en')) is-invalid @endif" name="name_en"
                                                               value="{{$editarea->name_en?$editarea->name_en:old('name_en')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_name_en')}}*" />
                                                ...
                                                <input type="text" class="form-control @if($errors->has('name_ar')) is-invalid @endif" name="name_ar"
                                                               value="{{$editarea->name_ar?$editarea->name_ar:old('name_ar')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_name_ar')}}*" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox" {{$editarea->is_active==1?'checked':''}} name="is_active"  id="is_active" value="1"/>
																<span></span>
															</label>
														</span>
													</div>
													...
													<div class="col-3">
														<input type="text" class="form-control @if($errors->has('display_order')) is-invalid @endif" name="display_order"  value="{{$editarea->display_order?$editarea->display_order:old('display_order')}}" autocomplete="off" />
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-3">
														<input type="text" class="form-control @if($errors->has('delivery_fee')) is-invalid @endif" name="delivery_fee"  value="{{$editarea->delivery_fee?$editarea->delivery_fee:old('delivery_fee')}}" autocomplete="off" />
                                                               @if($errors->has('delivery_fee'))
                                                               <div class="invalid-feedback">{{ $errors->first('delivery_fee') }}</div>
                                                               @endif
													</div>
													<label class="col-3 col-form-label">Express Delivery Fee</label>
													<div class="col-3">
														<input type="text" class="form-control @if($errors->has('express_delivery_fee')) is-invalid @endif" name="express_delivery_fee"  value="{{old('express_delivery_fee',$editarea->express_delivery_fee)}}" autocomplete="off" />

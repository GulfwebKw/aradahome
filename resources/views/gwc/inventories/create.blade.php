...
<head>
    <meta charset="utf-8"/>
    <title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.inventory.create')}}</title>
                ...
                <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            <h3 class="kt-subheader__title">{{__('adminMessage.inventory.create')}}</h3>
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:;"
                                   class="kt-subheader__breadcrumbs-link">{{__('adminMessage.inventory.create')}}</a>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head kt-portlet__head--lg">
                            <div class="kt-portlet__head-label">
                                ...
                                <h3 class="kt-portlet__head-title">{{__('adminMessage.inventory.create')}}</h3>
                            </div>
                                ...
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                                        ...
                                        @if(auth()->guard('admin')->user()->can('inventory-list') or auth()->guard('admin')->user()->can('pos-list'))
                                            <a href="{{url('gwc/inventories')}}"
                                               class="btn btn-brand btn-elevate btn-icon-sm"><i
                                                        class="la la-list-ul"></i>{{__('adminMessage.inventory.inventories')}}
                                            </a> @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        @if(auth()->guard('admin')->user()->can('inventory-create') or auth()->guard('admin')->user()->can('pos-create'))
                            ...
                            <form name="tFrm" id="form_validation" method="post"
                                  class="kt-form" enctype="multipart/form-data" action="{{route('inventories.store')}}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text"
                                                   ...
                                                   placeholder="{{__('adminMessage.title')}}"/>
                                            @if($errors->has('title'))
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="number"
                                                   class="form-control @if($errors->has('priority')) is-invalid @endif"
                                                   name="priority"
                                                   value="{{old('priority' , $maxPriority)}}" autocomplete="off"
                                                   placeholder="{{__('adminMessage.inventory.priority')}}*"/>

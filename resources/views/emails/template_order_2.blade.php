...
<table border="0" width="800" cellspacing="0" cellpadding="0"
    ...
    <tr>
        <td dir="{{$dir}}" align="<?php echo $align;?>"><p><b
                        style="font-size:14px;">{{__('webMessage.customerdetails')}}</b></p></td>
    </tr>

    <tr>
        <td dir="{{$dir}}" align="<?php echo $align;?>">

            <table class="customers" border="0" width="100%" cellpadding="0"
    ...
    @if(!empty($paymentDetails))
        <tr>
            <td dir="{{$dir}}" align="<?php echo $align;?>"><p><b
                            style="font-size:14px;">{{trans('webMessage.transactiondetails')}}</b></p></td>
        </tr>
        <tr>
            <td dir="{{$dir}}" align="<?php echo $align;?>">
                    ...
                    <td dir="{{$dir}}" align="center">
                        ...
                        <p>
                            <small>
                                ...
                                @if(!empty($settingInfo->phone))<br>{{__('webMessage.phone')}}
                                :{{$settingInfo->phone}}@endif
                                @if(!empty($settingInfo->mobile)),{{__('webMessage.mobile')}}
                                :{{$settingInfo->mobile}}@endif
                                @if(!empty($settingInfo->email))<br>{{__('webMessage.email')}}
                                :{{$settingInfo->email}}@endif
                            </small>
                        </p>
                    </td>
                </tr>
    ...
    <tr>
        <td align="center"><p class="text-center">{!!$trackYourOrder!!}</p>

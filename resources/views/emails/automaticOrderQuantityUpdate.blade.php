...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      <td style="padding:20px; font-family: arial, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif'; color: #2a0000; text-align: justify; font-size: 14px; line-height:23px;">
		  	<p>{!! $bodytxt !!}</p>
		</td>
    </tr>
    <tr>
